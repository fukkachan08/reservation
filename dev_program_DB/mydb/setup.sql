...
CREATE TABLE AVAILABLEQTY(
    ...
    QTY INTEGER,
    CONSTRAINT DATE_ROOMTYPE_PK PRIMARY KEY(DATE, ROOMTYPE)
);
CREATE TABLE RESERVATION(RESERVATIONNUMBER VARCHAR(50) NOT NULL PRIMARY KEY,STAYINGDATE VARCHAR(20),STATUS VARCHAR(10));
CREATE TABLE ROOM(ROOMNUMBER VARCHAR(50) NOT NULL PRIMARY KEY,STAYINGDATE VARCHAR(20), ROOMTYPE VARCHAR(10));

INSERT INTO ROOM VALUES('1001','', 'Twin');
INSERT INTO ROOM VALUES('1002','', 'Twin');
INSERT INTO ROOM VALUES('1003','', 'Twin');
INSERT INTO ROOM VALUES('1004','', 'Double');
INSERT INTO ROOM VALUES('1005','', 'Suite');
